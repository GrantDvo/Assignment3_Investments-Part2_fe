      ...
      <div class="card" v-for="investment in investments" v-bind:key="investment">
        ...
        <div :id="'collapse' + investment.pk" class="collapse" :aria-labelledby="'heading' +
          ...
          <div class="card-body">
            ...
            <div class="btn-group">
              <button @click="updateInvestment(investment)" style="background-color:
transparent; padding: 5;">
                <font-awesome-icon icon="pencil"/></button>
              <button @click="deleteInvestment(investment)" style="background-color: transparent;
padding: 5;">
    ...
    <div class="col col-12 col-md-10 d-none d-xl-block d-lg-block d-md-block">
      <table class="table table-hover" style="overflow-y: auto"
        ...
        <tr v-for = "investment in investments" v-bind:key="investment">
          ...
          <td @click="updateInvestment(investment)"><button style="background-color: transparent;
padding: 0;">
            <font-awesome-icon icon="pencil"/></button>
          </td>
          <td @click="deleteInvestment(investment)"><button style="background-color: transparent;
padding: 0;">
            <font-awesome-icon icon="trash"/></button>
          </td>
        </tr>
